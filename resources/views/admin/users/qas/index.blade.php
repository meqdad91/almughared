...
@section('content')
    <div class="page-header">
        <h2>Manage QA Staff</h2>
        <div class="page-actions">
            <a href="{{ route('admin.users.qas.create') }}" class="btn btn-app btn-app-primary btn-app-sm">+ Add QA</a>
        </div>
    </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="{{ route('admin.users.qas.edit', $admin->id) }}" class="btn btn-app btn-app-outline btn-app-sm">Edit</a>
    ...
    @else
        <div class="m-card">
            <div class="empty-state">
                ...
                <p>No QA staff found. Click <strong>Add QA</strong> to create one.</p>
            </div>
        </div>
    @endif
@endsection
