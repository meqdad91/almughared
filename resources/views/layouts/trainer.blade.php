...
<head>
    ...
    <title>Almughared - Trainer</title>
...
<body>
    @php
        ...
        $currentUser = \Illuminate\Support\Facades\Auth::guard('trainer')->user();
        $unreadCount = \App\Http\Controllers\MessageController::getUnreadCount($currentUser);
    @endphp

    <nav class="navbar navbar-expand-lg app-navbar">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ route('trainer.dashboard') }}">Almughared</a>
            ...
            <div class="collapse navbar-collapse" id="trainerNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ isActive('trainer.session.active') }}" href="{{ route('trainer.session.active') }}">Sessions</a>
                    </li>
                    <li class="nav-item">
