...
@section('content')
    ...
    <div class="page-header">
        ...
        <div class="page-actions">
            <a href="{{ route('qa.subjects.pending', $subject->session_id) }}" class="btn btn-app btn-app-light btn-app-sm">&larr; Back to Pending</a>
        </div>
    </div>
    ...
    <div class="m-card mb-4">
        <div class="m-card-body">
            <div class="d-flex justify-content-between align-items-start flex-wrap gap-2 mb-3">
                ...
                <span class="status-badge status-pending" style="font-size:0.85rem;">{{ ucfirst(str_replace('_', ' ', $subject->status)) }}</span>
            </div>
