    ...
    <div class="col-md-10 p-4" style="background: #f4f5f7">
        ...
        <div class="card shadow-sm rounded">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('qa.subjects.pending', $subject->session_id) }}" class="btn btn-light btn-sm">← Back to Pending</a>
            </div>
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <span class="badge bg-warning text-dark fs-6">{{ $subject->status }}</span>
                    </div>
                </div>
