...
@section('content')
    ...
    <div class="page-header">
        ...
        <div class="page-actions">
            <a href="{{ route('qa.weekly-plans.pending') }}" class="btn btn-app btn-app-light btn-app-sm">&larr; Back</a>
        </div>
    </div>
    ...
    @if($weeklyPlan->status === 'pending')
        <div class="d-flex gap-3">
            <form action="{{ route('qa.weekly-plans.approve', $weeklyPlan) }}" method="POST"
    ...
    <div class="modal fade" id="declineModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <form action="{{ route('qa.weekly-plans.decline', $weeklyPlan) }}" method="POST">
                @csrf
